...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'srsly.com'
  config.app_name = 'Srsly'
  config.mailer.from = 'Srsly <no-reply@srsly.com>'
  ...
  #
  config.app_secret = 'pXUJtM31iaJg7MBndln_dYqNgy4TpFhfxBCsKfR064sR9GVPvwVpivkGUEG_w7RdcW0'
